...
useEffect(()=>{
  ...
  return dashboardData ?(
    ...
    <div>
      <p className="text-lg font-medium text-gray-900">{dashboardData.enrolledStudentsData.length}</p>
    ...
    <div>
      <p className="text-lg font-medium text-gray-900">{dashboardData.totalCourses}</p>
    ...
    <div>
      <p className="text-lg font-medium text-gray-900">{currency} {dashboardData.totalEarnings}</p>
