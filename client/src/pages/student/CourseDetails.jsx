...
{courseData.courseContent.map((chapter,index) => (
    ...
    <div className={`overflow-hidden transition-all duration-300 ${openSection[index]? 'max-h-96 ':'max-h-0'}`}>
        <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 test-gray-600 border-t border-gray-300">
...
<button className="bg-blue-600 text-white md:mt-6 mt-4 w-full py-3 rounded font-medium">{isAlreadyEnrolled?"Already Enrolled":"Enroll Now"}</button>
<div className="pt-6">
