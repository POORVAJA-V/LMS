...
const [progressArray,setProgressArray] = useState([
  ...
  {lectureCompleted:6,totalLecture:41},
  {lectureCompleted:9,totalLecture:24},
  {lectureCompleted:2,totalLecture:13},
  {lectureCompleted:11,totalLecture:6},
  {lectureCompleted:12,totalLecture:9},
  {lectureCompleted:10,totalLecture:14},
        ...
        <tbody className="text-gray-700">
          {enrolledCourses.map((course,index)=>(
            <tr key={index} className="border-b border-gray-500/20">
              ...
              <td className="px-4 pd-3 max-sm:hidden">
              ...
              <td className="px-4 pd-3 max-sm:text-right">
