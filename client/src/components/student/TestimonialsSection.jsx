...
const TestimonialsSection = () => {
  return (
    <div className="pb-4 px-8 md:px-0">
        ...
        <p className="md:text-base text-gray-500 mt-3 ">Hear from our learners as they share thier journeys of transformation, sucess, and how our <br/>
        platform has made a difference in their lives.</p>
        <div className="grid grid-cols-auto gap-8 m-8">
